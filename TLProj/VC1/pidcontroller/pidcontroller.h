...
typedef struct Vca_DV_tag {
   const volatile UInt8 P_Ad;
   const volatile UInt8 P_Kd;
   const volatile UInt8 P_Ki;
   const volatile UInt8 P_Kp;
} Vca_DV_tp; /* Description: Struct data type for data variant configuration DV */
...
\******************************************************************************/
extern ACCESS_FUNCTION ADC Sa1_REF; /* LSB: 2^-11 OFF: 0 MIN/MAX: -10 .. 10 */
extern ACCESS_FUNCTION DAC Sa1_U_M; /* LSB: 2^-15 OFF: -1 MIN/MAX: -1 .. 0.999969482421875 */
extern ACCESS_FUNCTION ADC Sa1_U_X; /* LSB: 2^-11 OFF: 0 MIN/MAX: -10 .. 10 */

/******************************************************************************\
   CAL: global calibratable parameters (ROM) | Width: 8
\******************************************************************************/
extern CAL UInt8 VariantSwitch;

/******************************************************************************\
   CAL: global calibratable parameters (ROM) | Width: N.A.
\******************************************************************************/
extern CAL Vca_DV_tp Vca_DV_db_fast;

extern CAL Vca_DV_tp Vca_DV_fast;

extern CAL Vca_DV_tp Vca_DV_slow;
...
/******************************************************************************\
   GlobalAux: Default function class for functions which have 'not static' extent
\******************************************************************************/
extern void Vca_SwitchDV(void);

/******************************************************************************\
   GlobalRestart: Default function class for not static model restart functions
\******************************************************************************/
extern void RESTART_pidcontroller(void);

/******************************************************************************\
   GlobalStep: Default function class for not static model step functions
\******************************************************************************/
extern void pidcontroller(void);
